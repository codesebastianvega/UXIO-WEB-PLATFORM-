...
export const contentPlatformsTikTokGoogle: PlatformGroup[] = [
  {
    ...
    imageUrl: "/services/cards/content-tiktok-v2.jpg",
    ...
    microServices: [
      {
        id: "tiktok-scripts-4",
        title: "Guiones Virales con Ganchos Magnéticos (4 TikToks)",
        description: "Estructuras diseñadas para atrapar la atención en los primeros 3 segundos, mantener la retención y generar comentarios.",
        imageUrl: "/services/sprints/sprint-tiktok-scripts.jpg",
      ...
      {
        id: "ugc-video",
        title: "Video UGC con Creador de Contenido Real",
        description: "Grabación auténtica de demostración o reseña de tu producto con un creador afín a tu audiencia, listo para anuncios y reels.",
        imageUrl: "/services/sprints/sprint-ugc-video.jpg",
      ...
      {
        id: "tiktok-seo-audit",
        title: "Auditoría de Perfil y Posicionamiento en TikTok",
        description: "Optimizamos tu biografía, categorías y palabras clave para que tu negocio aparezca en los primeros resultados de búsqueda de TikTok.",
        imageUrl: "/services/sprints/sprint-tiktok-seo.jpg",
  ...
  },
  {
    ...
    imageUrl: "/services/cards/content-google-v2.jpg",
    ...
    microServices: [
      {
        ...
        title: "Perfil y Geolocalización en Google Mi Negocio",
        description: "Posiciona tu local en Google Maps y activa un sistema sencillo para conseguir reseñas positivas de 5 estrellas.",
        imageUrl: "/services/sprints/sprint-google-business.jpg",
      ...
      {
        id: "seo-blog-article",
        title: "Artículo de Autoridad Optimizado para Google (SEO)",
        description: "Texto de 1.200 a 1.500 palabras redactado estratégicamente para atraer clientes orgánicos desde las búsquedas de Google.",
        imageUrl: "/services/sprints/sprint-seo-blog.jpg",
      ...
      },
      {
        ...
        title: "Set de Banners Adaptables para Red de Display",
        description: "Anuncios gráficos en todos los tamaños oficiales de Google para impactar a personas que ya visitaron tu página (Remarketing).",
        imageUrl: "/services/sprints/sprint-google-display.jpg",
      ...
      },
      {
        ...
        title: "Investigación Estratégica de Palabras Clave",
        description: "Descubre exactamente qué buscan tus clientes potenciales en Google y qué términos negativos bloquear para no quemar presupuesto.",
        imageUrl: "/services/sprints/sprint-keyword-research.jpg",
        price: { USD: 110, COP: 450000 },
        accent: "#FF7F07",
        timeline: "48h",
        deliverables: [
      ...
      {
        id: "ga4-tech-setup",
        title: "Medición y Embudos de Conversión en GA4",
        description: "Instalamos y verificamos eventos de venta y formularios en Google Analytics 4 sin romper la velocidad de tu web.",
