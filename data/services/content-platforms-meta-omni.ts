...
export const contentPlatformsMetaOmni: PlatformGroup[] = [
  {
    ...
    microServices: [
      {
        id: "shooting-4h",
        title: "Jornada de Grabación Profesional (Shooting 4 Horas)",
        description: "Sesión presencial con cámaras 4K, luces y micrófonos para capturar todo el contenido audiovisual que tu marca necesita en el mes.",
        imageUrl: "/services/sprints/sprint-shooting-4h.jpg",
      ...
      {
        id: "audit-social",
        title: "Auditoría Integral de Instagram y Redes Sociales",
        description: "Evaluamos tu feed, historias y bio para descubrir por qué tus seguidores no se convierten en clientes y cómo corregirlo.",
        imageUrl: "/services/sprints/sprint-audit-social.jpg",
      ...
      {
        id: "linktree-bio",
        title: "Página de Enlaces Inteligente (Bio Multi-link)",
        description: "Tu propia landing rápida para Instagram y TikTok con botones directos a WhatsApp, catálogo y medición de clics.",
        imageUrl: "/services/sprints/sprint-linktree-bio.jpg",
  ...
  },
  {
    ...
    microServices: [
      {
        id: "carousel-edu",
        title: "Carrusel Educativo de Alta Retención (5 Diapositivas)",
        description: "Contenido gráfico de gran valor diseñado para que las personas guarden, compartan e interactúen con tu cuenta.",
        imageUrl: "/services/sprints/sprint-carousel-edu.jpg",
        price: { USD: 40, COP: 150000 },
        accent: "#F06C83",
        timeline: "24h",
        deliverables: [
      ...
      {
        id: "reel-edit",
        title: "Edición Dinámica de Video Corto (Reel / TikTok)",
        description: "Ritmo ágil, subtítulos animados estilo Alex Hormozi, efectos sonoros y música en tendencia para enganchar a la audiencia.",
        imageUrl: "/services/sprints/sprint-reel-edit.jpg",
      ...
      {
        id: "meta-shopping",
        title: "Catálogo y Tienda en Instagram y Facebook",
        description: "Vincula tus productos para que tus clientes puedan tocar una foto, ver el precio y comprar directamente sin salir de la app.",
        imageUrl: "/services/sprints/sprint-meta-shopping.jpg",
      ...
      {
        id: "ads-banners-3",
        title: "3 Banners Publicitarios para Pruebas A/B",
        description: "Diseños con diferentes enfoques visuales y llamadas a la acción para descubrir qué anuncio vende más barato.",
        imageUrl: "/services/sprints/sprint-ads-banners.jpg",
      ...
      },
      {
        ...
        title: "Paquete de 5 Plantillas Rápidas para Redes",
        description: "Modelos editables en Canva o Figma con los colores de tu empresa para que crees publicaciones en menos de 5 minutos.",
        imageUrl: "/services/sprints/sprint-social-templates.jpg",
