...
/**
 * MagneticPillButton - A physics-driven CTA button with proximity magnetism,
 * 3D inner parallax displacement, and customizable dynamic glow.
 * 
...
export default function MagneticPillButton({
  ...
  const handleMouseMove = useCallback((e: MouseEvent) => {
    ...
    if (distance < triggerRadius) {
      setIsNear(true);
      // Magnetic pull with cubic attenuation (stronger near center)
  ...
  return (
    <div
      ref={containerRef}
      className="inline-flex items-center justify-center p-8 -m-8 relative"
    >
      <button
        ref={buttonRef}
        ...
        style={{
          ...
          transition: isNear
            ...
            : 'transform 0.65s cubic-bezier(0.25, 1.4, 0.5, 1)',
        }}
        className={`
          relative inline-flex items-center justify-center rounded-full
          font-sans font-bold tracking-tight cursor-pointer select-none
          active:scale-95 shadow-md hover:shadow-xl transform-gpu
          ${sizeClasses}
          ${variantStyles}
          ${className}
        `}
